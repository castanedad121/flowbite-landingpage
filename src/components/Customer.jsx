  ...
  return (
    <>
      <section className="bg-white dark:bg-gray-900">
        <div className="py-16 lg:pb-32 mx-auto max-w-screen-xl px-4">
            ...
            <a href="#" className="flex justify-center items-center">
              {theme === "light" ? (
                <img
                  ...
                  alt=""
                  className="m-auto h-28 opacity-50  hover:opacity-100"
                />
              ) : (
                <img
          ...
          <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-5 dark:text-gray-400 sm:pt-8">
            <a href="#" className="flex justify-center items-center">
              {theme === "light" ? (
                <img
